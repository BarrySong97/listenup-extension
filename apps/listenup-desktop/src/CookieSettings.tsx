 ...
 * @deps    @tauri-apps/api/core、HeroUI wrappers
...
export const CookieSettings = ({
  ...
  return (
    <div className="absolute inset-0 z-20 overflow-y-auto bg-[#11151c]/98 p-5 backdrop-blur">
      <div className="mx-auto max-w-xl rounded-2xl border border-white/10 bg-white/[0.035] p-5 shadow-2xl">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <h2 className="m-0 text-sm font-semibold text-white">YouTube Cookie</h2>
            <p className="mb-0 mt-1 text-[11px] leading-relaxed text-white/50">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <DesktopButton
            ...
            onPress={() => void save()}
          >
            {pending === "save" ? "保存中…" : status === "missing" ? "保存 Cookie" : "替换 Cookie"}
          </DesktopButton>
          <DesktopButton
