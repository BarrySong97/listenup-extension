# ListenUp Extension 文档入口

> 目的: 作为 extension app 的长期文档入口，告诉协作者从哪里开始读、每类知识放在哪里
>
> 源码路径: `apps/extension/docs/`
>
...
- [workflows.md](workflows.md): extension 开发、提交流程和文档同步要求
- [testing.md](testing.md): extension 当前测试方式、最低验证要求和手工回归清单
