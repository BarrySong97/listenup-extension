 ...
 * @deps    React、Iconify、Desktop UI primitives、embeddedPlayback
...
export const BrowserSourceSwitchModal = ({
  ...
  return (
    <div
      className="absolute inset-0 z-30 grid place-items-center bg-glass/95 p-5 backdrop-blur-xl"
      role="dialog"
      aria-modal="true"
      aria-labelledby="browser-source-switch-title"
